...
from mani_skill.examples.cvla.utils_trajectory import project_points, clip_and_interpolate
from mani_skill.examples.cvla.utils_trajectory import unproject_points, generate_curve_torch
...
class TrajectoryEncoder_xyzrotvec_1024xy:
    ...
    def decode_caption(self, caption: str, camera=None, robot_pose=None):
        ...
        try:
            ...
            raise ValueError(f"Failed to decode caption {caption} {e}")
...
def check_encode_decode():
    ...
    _, _, token_str = action_encoder.encode_trajectory(points_3d, orns_3d, camera, robot_pose=robot_pose)
    ...
    _, _, token_str = enc(points_3d, orns_3d, camera, robot_pose=robot_pose)
    ...
    for encoder_name in encoder_names:
        ...
        _, _, token_str = enc.encode_trajectory(points_3d, orns_3d, camera, robot_pose=robot_pose)
